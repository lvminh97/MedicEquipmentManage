...
public class AddEquipmentView extends JFrame{
	private static final long serialVersionUID = 1L;
	
	private JTextField idTf, nameTf, statusTf, producerTf, providerTf, priceTf, numberTf;
	private JTextArea functionTarea;
	private JButton addBtn;
	
	public AddEquipmentView() {
		this.setTitle("Thêm thiết bị mới");
		...
		numberLb.setSize(80, 30);
		numberLb.setLocation(20, 440);
		this.add(numberLb);
		this.numberTf = new JTextField();
		this.numberTf.setSize(350, 30);
		this.numberTf.setLocation(200, 440);
		this.add(this.numberTf);
		
		this.addBtn = new JButton("Thêm thiết bị");
		this.addBtn.setSize(200, 40);
		this.addBtn.setLocation(200, 520);
